                    ...
                    handler: {
                        ...
                        change: function(e, t, a) {
                            var r, n, o, s = i.deepMerge({}, e || {}),
                                ...
                                c = l ? l._objects ? l._objects : [l] : null;
                            if(s.mode && (i.drawing.mode = s.mode), s.width && (i.drawing.width = s.width, i.drawing.fontSize = s.fontSize = 3 * s.width, 1 == i.drawing.width && (i.drawing.fontSize = s.fontSize = i.defaults.fabric.drawing.fontSize)), s.fontSize && (i.drawing.fontSize = s.fontSize), s.color && (i.drawing.color = s.color), s.opacity && (i.drawing.opacity = s.opacity), (o = i.getRGBA(i.drawing.color)).pop(), o.push(i.drawing.opacity), i.drawing.color = "rgba(" + o.join() + ")", i.setup.fabric.freeDrawingBrush.color = i.drawing.color, i.setup.fabric.freeDrawingBrush.width = i.drawing.width, l) {
                                for((r = JSON.parse(l.recentState).cfg) && (s.color = s.color || r.color, s.width = s.width || r.width, s.opacity = s.opacity || r.opacity, s.fontSize = s.fontSize || r.fontSize, (o = i.getRGBA(s.color)).pop(), o.push(s.opacity), s.color = "rgba(" + o.join() + ")"), n = 0; n < c.length; n++) c[n] instanceof fabric.Text || c[n] instanceof fabric.PathGroup || c[n] instanceof fabric.Triangle ? ((s.color || s.opacity) && c[n].set({
                                    fill: s.color
                                }), s.fontSize && c[n].set({
                                    fontSize: s.fontSize
                                })) : (c[n] instanceof fabric.Path || c[n] instanceof fabric.Line) && (l instanceof fabric.Group ? (s.color || s.opacity) && c[n].set({
                                    stroke: s.color
                                }) : ((s.color || s.opacity) && c[n].set({
                                    stroke: s.color
                                }), s.width && c[n].set({
                                    strokeWidth: s.width
                                })));
                ...
                capture: function(e, t) {
                    ...
                    for(i.setup.fabric = new fabric.Canvas(i.setup.canvas, u), i.deepMerge(i.setup.fabric, r), i.deepMerge(i.setup.fabric.freeDrawingBrush, r.drawing), i.deepMerge(i.drawing, r.drawing), i.drawing.handler.change(r.drawing), i.setup.fabric.on("mouse:down", function(e) {
                        ...
                        "stock" == i.setup.chart.type && i.setup.chart.legendSettings.position ? -1 != ["top", "bottom"].indexOf(i.setup.chart.legendSettings.position) ? f.parent.style.top && f.parent.style.left ? (f.offset.y = i.pxToNumber(f.parent.style.top), f.offset.x = i.pxToNumber(f.parent.style.left)) : (f.offset.x = o.x, f.offset.y = o.y, o.y += i.pxToNumber(f.parent.style.height), f.has.panel ? (o.pY = i.pxToNumber(f.has.panel.style.marginTop), f.offset.y += o.pY) : f.has.scrollbar && (f.offset.y += o.pY)) : -1 != ["left", "right"].indexOf(i.setup.chart.legendSettings.position) && (f.offset.y = i.pxToNumber(f.parent.style.top) + o.pY, f.offset.x = i.pxToNumber(f.parent.style.left) + o.pX, f.has.legend ? o.pY += i.pxToNumber(f.has.panel.style.height) + i.setup.chart.panelsSettings.panelSpacing : f.has.scrollbar && (f.offset.y -= i.setup.chart.panelsSettings.panelSpacing)) : ("absolute" == f.parent.style.position ? (f.offset.absolute = !0, f.offset.top = i.pxToNumber(f.parent.style.top), f.offset.right = i.pxToNumber(f.parent.style.right, !0), f.offset.bottom = i.pxToNumber(f.parent.style.bottom, !0), f.offset.left = i.pxToNumber(f.parent.style.left), f.offset.width = i.pxToNumber(f.parent.style.width), f.offset.height = i.pxToNumber(f.parent.style.height)) : f.parent.style.top && f.parent.style.left ? (f.offset.y = i.pxToNumber(f.parent.style.top), f.offset.x = i.pxToNumber(f.parent.style.left)) : f.legend ? ("left" == f.legend.position ? o.x = l.maxWidth : "right" == f.legend.position ? f.offset.x = o.width - l.maxWidth : "top" == f.legend.position ? o.y += f.legend.height : "bottom" == f.legend.position && (f.offset.y = o.height - l.height), f.offset.y += o.lY, o.lY += f.legend.height) : (f.offset.x = o.x, f.offset.y = o.y + o.pY, o.y += i.pxToNumber(f.parent.style.height)), f.has.legend && f.has.panel && f.has.panel.style.marginTop ? (o.y += i.pxToNumber(f.has.panel.style.marginTop), f.offset.y += i.pxToNumber(f.has.panel.style.marginTop)) : i.setup.chart.legend && -1 != ["left", "right"].indexOf(i.setup.chart.legend.position) && (f.offset.y = i.pxToNumber(f.parent.style.top), f.offset.x = i.pxToNumber(f.parent.style.left))), fabric.parseSVGDocument(f.svg, function(e) {
                            return function(a, l) {
                                var c, d = fabric.util.groupSVGElements(a, l),
                                    f = [],
                                    p = {
                                        selectable: !1,
                                        isCoreElement: !0
                                ...
                                for(e.offset.absolute ? (void 0 !== e.offset.bottom ? p.top = o.height - e.offset.height - e.offset.bottom : p.top = e.offset.top, void 0 !== e.offset.right ? p.left = o.width - e.offset.width - e.offset.right : p.left = e.offset.left) : (p.top = e.offset.y, p.left = e.offset.x), c = 0; c < d.paths.length; c++) {
                                    ...
                                    if(d.paths[c]) {
                                        ...
                                        if(d.paths[c].fill instanceof Object) "radial" == d.paths[c].fill.type && -1 == ["pie", "gauge"].indexOf(i.setup.chart.type) && (d.paths[c].fill.coords.r2 = -1 * d.paths[c].fill.coords.r1, d.paths[c].fill.coords.r1 = 0, d.paths[c].set({
                                            opacity: d.paths[c].fillOpacity
                                        }));
                                        else if((u = i.isHashbanged(d.paths[c].fill)) && e.patterns && e.patterns[u]) {
                                            var g = e.patterns[u];
                                ...
                                if(d.paths = f, p.top += .5, p.left += .5, d.set(p), i.setup.fabric.add(d), e.svg.parentNode && e.svg.parentNode.getElementsByTagName) {
                                    ...
                                    for(c = 0; c < h.length; c++)
                                        if(r.balloonFunction instanceof Function) r.balloonFunction.apply(i, [h[c], e]);
                                        else {
                                            var m = h[c],
                            ...
                            for(a = 0; a < l.length; a++) {
                                var c = l[a],
                                    d = String(e.getAttribute(c) || "none"),
                                    f = Number(e.getAttribute(c + "-opacity") || "1"),
                                    p = i.getRGBA(d);
                                ...
                                for(i1 = 0; i1 < o.length; i1++)
                                    if(o[i1]) {
                                        var l = o[i1].replace(/\s/g, "").split(":"),
                                            c = l[0],
                                            d = l[1];
                                        if(-1 != ["fill", "stroke"].indexOf(c))
                                            if(d = i.getRGBA(d, !0)) {
                                                var f = "#" + d.toHex(),
                                                    p = d._source[3];
                                                s.push([c, f].join(":")), s.push([c + "-opacity", p].join(":"))
                                            } else s.push(o[i1]);
                                        else "opactiy" != c && s.push(o[i1])
                                    }
                            ...
                            if(i.setup.chart.comparedGraphs.length) {
                                ...
                                for(a = 0; a < i.setup.chart.comparedGraphs.length; a++) {
                                    ...
                                    for(r = 0; r < v.dataSet.dataProvider.length; r++) {
                                        var d = v.dataSet.categoryField,
                                            f = v.dataSet.dataProvider[r][d],
                                            p = o.indexOf(f);
                                        if(-1 != p)
                    ...
                    if(n.data.length) {
                        ...
                        for(a = 0; a < n.data.length; a++) {
                            ...
                            for(r = 0; r < n.dataFields.length; r++) {
                                var c = n.dataFields[r],
                                    d = n.dataFieldsMap[c],
                                    f = n.columnNames && n.columnNames[c] || n.titles[c] || c,
                                    p = n.data[a][d];
                    ...
                    function r(t, a) {
                        ...
                        for(o = 0; o < t.length; o++) {
                            var c = "string" == typeof t[o] ? {
                                ...
                                g = String(c.action ? c.action : c.format).toLowerCase();
                            if(c.format = String(c.format).toUpperCase(), d.addEventListener("mouseleave", function(e) {
                                ...
                                else if(!c.populated && c.action && -1 != c.action.indexOf("draw.")) {
                                    var h = c.action.split(".")[1],
                                        m = c[h] || i.config.fabric.drawing[h] || [];
